...
for (var i = 0; i < elements.length; i++) {
    ...
    for (var j = 0; j < element.childNodes.length; j++) {
        ...
        if (node.nodeType === 3) {
            ...
            var replacedText = text.replace(/Gary Gillespie/gi, "Big Boi");
...
for (var i = 0; i < elements.length; i++) {
    ...
    for (var j = 0; j < element.childNodes.length; j++) {
        ...
        if (node.nodeType === 3) {
            var text = node.nodeValue;
            var replacedText = text.replace(/Gillespie/gi, "Almighty");
...
for (var i = 0; i < elements.length; i++) {
    ...
    for (var j = 0; j < element.childNodes.length; j++) {
        ...
        if (node.nodeType === 3) {
            var text = node.nodeValue;
            var replacedText = text.replace(/Gary/gi, "the Lord");
